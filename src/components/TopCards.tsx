...
function TopCards() {
  ...
  const [yesterdayData, setYesterdayData] = useState<DataInterface | null>(
    null
  );
  useEffect(() => {
    try {
      axios(graphQLOptions).then((response) => {
        ...
        setLatestData({
          ...
          totalSupplyStr: Number(obj.totalSupply).toLocaleString(undefined, {
            maximumFractionDigits: 2,
            minimumFractionDigits: 2,
          }),
          totalBorrows: obj.totalBorrows,
          totalBorrowsStr: Number(obj.totalBorrows).toLocaleString(undefined, {
            maximumFractionDigits: 2,
            minimumFractionDigits: 2,
          }),
          supplyRate: obj.supplyRate,
          reserves: obj.reserves,
          reservesStr: Number(obj.reserves).toLocaleString(undefined, {
            maximumFractionDigits: 2,
            minimumFractionDigits: 2,
          }),
          cash: obj.cash,
          cashStr: Number(obj.cash).toLocaleString(undefined, {
            maximumFractionDigits: 2,
            minimumFractionDigits: 2,
          }),
          borrowRate: obj.borrowRate,
          price: obj.underlyingPriceUSD,
          priceStr: Number(obj.underlyingPriceUSD).toLocaleString(undefined, {
  ...
  const supplyDiff = Number(
    Number(
      ((latestData.totalSupply - yesterdayData.totalSupply) * 100) /
        latestData.totalSupply
    ).toLocaleString(undefined, {
      maximumFractionDigits: 2,
      minimumFractionDigits: 2,
    })
  );
  console.log(`supply diff ${supplyDiff}`)
  const borrowsDiff = Number(
    Number(
      ((latestData.totalBorrows - yesterdayData.totalBorrows) * 100) /
        latestData.totalBorrows
    ).toLocaleString(undefined, {
      maximumFractionDigits: 2,
      minimumFractionDigits: 2,
    })
  ...
  const cashDiff = Number(
    Number(
      ((latestData.cash - yesterdayData.cash) * 100) / latestData.cash
    ).toLocaleString(undefined, {
      maximumFractionDigits: 2,
      minimumFractionDigits: 2,
    })
  );
  const reservesDiff = Number(
    Number(
      ((latestData.reserves - yesterdayData.reserves) * 100) /
        latestData.reserves
    ).toLocaleString(undefined, {
      maximumFractionDigits: 2,
      minimumFractionDigits: 2,
  ...
  const priceDiff = Number(
    Number(
      ((latestData.price - yesterdayData.price) * 100) / latestData.price
    ).toLocaleString(undefined, {
      maximumFractionDigits: 2,
      minimumFractionDigits: 2,
    })
  ...
  return (
    <div className="grid lg:grid-cols-9 grid-cols-5 gap-4 p-4">
      <div className="lg:col-span-2 col-span-1 bg-white flex justify-between w-full border p-4 rounded-lg">
        <div className="flex flex-col w-full pb-4">
          <p className="text-2xl font-bold">
            {latestData.totalSupplyStr} {latestData.symbol}
          </p>
      ...
      <div className="lg:col-span-2 col-span-1 bg-white flex justify-between w-full border p-4 rounded-lg">
        <div className="flex flex-col w-full pb-4">
          <p className="text-2xl font-bold">
            {latestData.totalBorrowsStr} {latestData.symbol}
          </p>
      ...
      <div className="lg:col-span-2 col-span-1 bg-white flex justify-between w-full border p-4 rounded-lg">
        <div className="flex flex-col w-full pb-4">
          <p className="text-2xl font-bold">
            {latestData.cashStr} {latestData.symbol}
          </p>
        ...
        >
          <span
            className={
              cashDiff < 0 ? "text-red-700 text-lg" : "text-green-700 text-lg"
            }
          >
            {cashDiff}%
          </span>
      ...
      <div className="lg:col-span-2 col-span-1 bg-white flex justify-between w-full border p-4 rounded-lg">
        <div className="flex flex-col w-full pb-4">
          <p className="text-2xl font-bold">
            {latestData.reservesStr} {latestData.symbol}
          </p>
      ...
      <div className="col-span-1 bg-white flex justify-between w-full border p-4 rounded-lg">
        ...
        >
          <span
            className={
              priceDiff < 0 ? "text-red-700 text-lg" : "text-green-700 text-lg"
            }
          >
            {priceDiff}%
          </span>
